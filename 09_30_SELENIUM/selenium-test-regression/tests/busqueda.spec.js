...
// Si descargaste msedgedriver.exe manualmente, asegúrate de que la carpeta donde está (por ejemplo, C:\WebDriver\bin) esté en tu variable de entorno PATH del sistema.
// Si no, puedes agregarla temporalmente así:
// Asegúrate de que la ruta donde está msedgedriver.exe versión 140 esté al principio del PATH
// process.env.PATH = 'C:\\Program Files\\WebdriverEdge;' + process.env.PATH;
process.env.PATH = 'C:\\WebDriver\\bin;' + process.env.PATH;
